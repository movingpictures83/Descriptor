...
class DescriptorPlugin:
    ...
    def output(self, outputfile):
        ...
        os.system("singularity exec "+PyPluMA.prefix()+"/"+self.parameters["container"]+" python plugins/Descriptor/run_Descriptor.py --input_dir "+PyPluMA.prefix()+"/"+self.parameters["input_dir"]+" --output_file "+outputfile+" --db_pickle "+PyPluMA.prefix()+"/"+self.parameters["db_pickle"])
